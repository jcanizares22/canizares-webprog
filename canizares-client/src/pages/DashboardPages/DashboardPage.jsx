...
import { statsData, barData, pieData, usersData } from '../../data/dashboardData.js';
  ...
  return (
    <>
      ...
      <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} sx={{ mb: 4 }} display="flex">
        ...
        <Card>
          <CardContent>
            ...
            <Typography variant="h4">{statsData.avgAge}</Typography>
          </CardContent>
        </Card>
      ...
      <Stack direction={{ xs: 'column', md: 'row' }} spacing={3} sx={{ mb: 4 }}>
        ...
        <Gauge width={100} height={100} value={50} minValue={10} maxValue={60} />
      </Stack>
